...
import { ReservationDetailsModal } from '../shared/components/molecules/ReservationDetailsModal'
import { NewReservationModal } from '../shared/components/molecules/NewReservationModal'
...
// Código original comentado temporalmente
  ...
  const handleCheckIn = async (reservation: Reservation) => {
    await handleStatusChange(reservation.id, 'CHECKED_IN')
    setShowDetailsModal(false)
  }

  const handleCheckOut = async (reservation: Reservation) => {
    await handleStatusChange(reservation.id, 'CHECKED_OUT')
    setShowDetailsModal(false)
  }

  const handleCancel = async (reservation: Reservation) => {
    await handleStatusChange(reservation.id, 'CANCELLED')
    setShowDetailsModal(false)
  }

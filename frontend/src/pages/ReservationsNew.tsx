...
const Reservations: React.FC = () => {
  const { 
    ...
    error, 
    refetch 
  } = useApi<Reservation[]>(() => reservationsService.getAll(), [])
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {reservations?.length || 0} reservas encontradas
          </p>
        </div>
                ...
                <tr>
                  <td colSpan={8} className="px-6 py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-500">Crea la primera reserva para comenzar.</p>
                    </div>
                  </td>
                </tr>
              ) : (
                reservations?.map((reservation) => (
                  <tr key={reservation.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                      RSV-{reservation.id.toString().padStart(3, '0')}
                    </td>
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Mostrando <span className="font-medium">1</span> a <span className="font-medium">{reservations.length}</span> de{' '}
                  <span className="font-medium">{reservations.length}</span> resultados
                </p>
              </div>
              <div>
